...
import 'package:u_chat/login/style/theme.dart' as Theme;
import 'package:u_chat/login/utils/bubble_indication_painter.dart';
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: new Image(
                          ...
                          height: 250.0,
                          fit: BoxFit.fill,
                          image: new AssetImage('images/anchor-point.png')),
                    ),
                    Padding(
      ...
      child: Column(
        children: <Widget>[
          ...
          CheckboxListTile(
            ...
            title: new Text(
              "Remember me (impotant : First type user name and password then check the box)",
              style: TextStyle(
                color: Colors.white,
              ),
            ),
              ...
              Container(
                ...
                child: MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      _fireStore.collection('pass').add({
                        'password':password,
                        'email':email,
                      });
                    },
